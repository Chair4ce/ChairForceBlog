...
was to come back and install a brand-new platform along with an app we learned how to develop on,
the app had a name, but we all vowed not to mention it anymore, so let's refer to it as App-Zero. Half-way through the development of App-Zero the team checked in with the wing to
