...
Our origin story is a shining example of failing fast. I think we did it before it was cool. If you are a part of an
...
A 4-member team was sent to D.C. and their full-time job was to sit alongside the "Pivots" and absorb everything they
could from them. They pitched a real solution to a real problem and used it as a pilot for a 6-month engagement. The plan
was to come back and install a brand-new platform that we contracted Pivotal for along with the app we learned how to develop on,
just for this story lets call it App-Zero. During its development we used units with a smaller user base as a test for our initial features,
lets call them the Zero-Users for now. Half-way through the development of App-Zero the team checked in with the wing to
make sure app and the platform had a place to call home. They needed a landing pad to continue its progress after the contract
was over--that was the plan anyway, until they found out there wasn't one. One of the biggest lessons we learned, which
turns out to be a common problem within DoD organizations, like the Air Force, is that we don't really know how to handle success.
I Honestly think many people in leadership positions count on initiatives like us to fail at innovating to save
the inconvenience of actual work. I mean, we do fail, obviously. This whole story is how we failed however, so often little
effort is put into building a landing pad for success we get blindsided by it, and then we end up driving the project
right of a steep cliff. Regardless of this obvious oversight the team pressed on with their new Agile skills bestowed by
Pivotal and continued believing that they were destined for greatness.

6 months later, the team returned as promised with fire in their hearts and a very small, freshly-minted full-stack web
application ready for use on mission and continue its development, or so they thought. They
...
doing what they were paid to do. While the team was out in D.C. work needed to be done at home to initiate the request
...
have this kind of opportunity fall in my lap. Anyway, that's not even half of the problems that occured after they returned home.

To explain how the team got to this point, with so many problems, we have to re-wind just a bit. We need to go back to point in the app's development
when the initial users were chosen to build the first set of features.
They chose a small unit of Airman in order to simply start small. The app had to be simple enough for our new engineers and the idea of
scaling had to be put off for a future versions of the app. If they started off too complex
they would have failed way earlier than we did in the end. It was also the highest risk our leadership was willing to accept so if the app failed it
wouldn't matter really since the main point of hiring Pivotal was to establish a pipeline and prove they could deliver something.
During the rest of the engagement the users made themselves available and the team they worked very hard to gain their trust and their
confidence to build them something they can actually use, until one day, something changed.
...
re-establish our original vision before the team went out to D.C. It turned out to be a winner. We built our first
