...
Probably one of the most difficult things to do in the Air Force is finding people that code and obtain permission from
...
roles and each required its own special personality. These are listed in order from the easiest to the hardest position to fill with talent:
...
I could elaborate on each one and I probably will at some point but the point I want to make here is really about talent management, the Air Force
...
See attachment 1 for the ‘hard copy’ backup of the survey.

### Phase 2.

The SDT Product Managers reach out to members that have survey responses in keeping with the goals of the team either by phone or email. SDT product managers schedule a Q&A session with the potential team member and the current members of the position of interest, i.e product designers, product managers, or software engineers. The Product Manager will send out a calendar invite on NIPRNet to the member and include, current SDT members attending, the member’s Flight Chief, and CEM for situational awareness.

### Phase 3.

If the member passes the Q&A session, he or she will be asked to complete a more in-depth pairing session where and SDT member will run through some applicable programs and troubleshooting to assess the member’s knowledge and ability to adapt and learn. Member’s Flight Chief and CEM will again be included in the calendar invite for situational awareness.

### Phase 4.

If phase 3 goes well, the Cyber Flight Superintendent and/or SDT Section Chief will attend the next available 497 ISRG Deliberate Development Briefing (DDB) to provide an update on the members we would like to join the team. Those leaders will make a determination, possibly at a later date, whether the mission and manning permits the member to join the team. SDT Section Chief will follow up as necessary.

### Phase 5.

The following training will be completed on lynda.com by new members upon assignment to the Software Development Team:
...
to work as a team until the previous cycle member rotates back to their unit. The process will continue in the manner. Cycles are ideally a 9-month continuous period.
...
Now of-course this is bust barebones framework which you should expand on to fit your team. You might want to have something
similar to give the enlisted leader the warm and fuzzy that you have a plan. Does it work? not sure. We
did get a great deal of interest from Airmen around the group that wanted to join but their leadership was apprehensive
about sending them in the fire without a plan. The need for a training plan wasn't necessarily "organic" because we
...
their mission. And It worked. Over time, we didn't have to convince them anymore, they knew the value would be there.

Okay so you built a team, now what? Building an environment that
allows your team to respect each other will be difficult, teams don't get along by default, and it's up to you as a
product manager to establish this framework from the beginning. These techniques will help you build a culture that
