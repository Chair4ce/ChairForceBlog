...
If phase 3 goes well, the Cyber Flight Superintendent and/or SDT Section Chief will attend the next available Deliberate Development Briefing (DDB) to provide an update on the members we would like to join the team. Those leaders will make a determination, possibly at a later date, whether the mission and manning permits the member to join the team. SDT Section Chief will follow up as necessary.

### Phase 5.

The following training will be complete an online training like Digital University or Cloud Guru upon assignment to the Software Development Team:
