...
It's not an additional duty, it's not a weekend or night thing so don't try to sell it like it's something they can do on
...
I'd like to see you try and beat that. Yea, Yea, I know, we failed. However, it had nothing to do with how little money we spent. I'll explain what happen in the end but that's for a
...
It would require more resources than any of us had at the time to correct toxic behavior, so we chose not to deal with it from the beginning.
Most of the toxic traits I have seen come from selfish individuals with an inability to handle conflict resolution and the
unwillingness to learn. These usually
...
to conduct interviews with specific scenarios that expose unwanted traits.

May this be one of the most important things you take from this blog. Toxic team members are far more expensive than just bad software. I don't care how well you code, design or manage, if teammates ony listen to you because of your
'seniority' it's time to move on. You know you have become the subject-matter expert (SME) or the team a-hole when no one ever challenges you. Which one are you?
Are your teammates comfortable enough with how you deal with conflict to challenge you? Can you effectively communicate
facts and ideas to convince others that your idea is better without using seniority? and without making them feel like you bullied them into agreeing with you?

Anyway, I'll probably git-branch that into another post, moving on. Your idea of passion may be very different from ours so figure out what kind of passion you want on your team before inviting members to join you.
There was also a stigma that you have to know how to code to be on a software development team. We had a slight education hurdle in addition to convincing leadership to let them go during recruiting periods.

In the end we knew we needed a certain kind of attitude and aptitude. We generally chose individuals that had a natural curiosity
and passion for problem-solving and learning over those with pre-qualifying skills. We learned that problem-solving skills are much harder to teach than coding skills. This concept turned out extremely well for us at the beginning.
Only when we started deviating from this did we start to go downhill, we got desperate, and it turned out to be catastrophic.
I'll leave this as a crumb to one of a few major factors leading to our downfall as a team. This will be its own post on why recruiting and your hiring authority needs to stay in-house.
